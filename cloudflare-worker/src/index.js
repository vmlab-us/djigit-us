...
export const curatedModels = {
  ...
  Audi:["A3","A5","A6","A7","A8","Q3","Q4 e-tron","Q5","Q6 e-tron","Q7","Q8","e-tron GT"],
  ...
  Cadillac:["CT4","CT5","Escalade","Escalade IQ","LYRIQ","OPTIQ","VISTIQ","XT5","XT6"],
  Chevrolet:["Blazer","Blazer EV","Bolt","Colorado","Corvette","Equinox","Equinox EV","Express","Silverado 1500","Silverado 2500HD","Silverado 3500HD","Silverado EV","Suburban","Tahoe","Trailblazer","Traverse","Trax"],
  Chrysler:["Pacifica","Voyager"],
  Dodge:["Charger","Durango","Hornet"],
  Ford:["Bronco","Bronco Sport","E-Transit","Escape","Expedition","Explorer","F-150","F-150 Lightning","Maverick","Mustang","Mustang Mach-E","Ranger","Super Duty","Transit"],
  ...
  Hyundai:["Elantra","IONIQ 5","IONIQ 6","IONIQ 9","Kona","Palisade","Santa Cruz","Santa Fe","Sonata","Tucson"],
  Jeep:["Cherokee","Compass","Gladiator","Grand Cherokee","Grand Cherokee L","Grand Wagoneer","Recon","Wagoneer","Wagoneer S","Wrangler"],
  Kia:["Carnival","EV6","EV9","K4","K5","Niro","Seltos","Sorento","Soul","Sportage","Telluride"],
  Lexus:["ES","GX","IS","LC","LS","LX","NX","RX","RZ","TX","UX"],
  Mazda:["CX-30","CX-5","CX-50","CX-70","CX-90","Mazda3","MX-5 Miata"],
  "Mercedes-Benz":["C-Class","CLA","CLE","E-Class","EQB","EQE","EQS","G-Class","GLA","GLB","GLC","GLE","GLS","S-Class","SL","AMG GT","Sprinter"],
  Nissan:["Ariya","Armada","Frontier","Kicks","Leaf","Murano","Pathfinder","Rogue","Sentra","Z"],
  Porsche:["718","911","Cayenne","Macan","Panamera","Taycan"],
  Ram:["1500","2500","3500","ProMaster"],
  Subaru:["Ascent","BRZ","Crosstrek","Forester","Impreza","Outback","Solterra","WRX"],
  Tesla:["Cybertruck","Model 3","Model S","Model X","Model Y"],
  Toyota:["4Runner","bZ","bZ4X","Camry","Corolla","Corolla Cross","Crown","Crown Signia","GR Corolla","GR Supra","GR86","Grand Highlander","Highlander","Land Cruiser","Mirai","Prius","RAV4","Sequoia","Sienna","Tacoma","Tundra"],
